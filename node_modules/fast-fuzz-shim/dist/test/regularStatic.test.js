...
describe('Regular static methods.', function () {
    ...
    it('Fuzz simple method static', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const method = results.find((result) => result.name === 'regular_static_simple');
    ...
    it('Fuzz regular method static', () => __awaiter(this, void 0, void 0, function* () {
        const results = global.fastFuzzResults;
        const method = results.find((result) => result.name === 'regular_static_regular');
        (0, chai_1.expect)(method).to.not.equal(undefined);
    ...
    it('Fuzz async interface static', () => __awaiter(this, void 0, void 0, function* () {
        const results = global.fastFuzzResults;
        const method = results.find((result) => result.name === 'regular_static_IAsync');
        (0, chai_1.expect)(method).to.not.equal(undefined);
        (0, chai_1.expect)(method.results.length).to.greaterThanOrEqual(4);
    }));
    it('Fuzz async method static', () => __awaiter(this, void 0, void 0, function* () {
        const results = global.fastFuzzResults;
        const method = results.find((result) => result.name === 'regular_static_async');
        (0, chai_1.expect)(method).to.not.equal(undefined);
